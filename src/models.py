...
class BookUpdateModel(BaseModel):
    """
    Modello per aggiornare un libro.
    """
...
class BookCreateModel(BaseModel):
    """
    Modello per creare un nuovo libro.
    """
    title: str
    author: str
    publisher: Optional[str] = None
...
class BookEditParams(BaseModel):
    """
    Modello per modificare i metadati di un libro.
    """
    title: Optional[str] = None
    author: Optional[str] = None
    publisher: Optional[str] = None
...
class BookDeleteParams(BaseModel):
    """
    Modello per la cancellazione di un libro.
    """
    book_id: int
